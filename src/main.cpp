...
//      for (PageIterator page_iter = (*iter).begin(); page_iter != (*iter).end();
//          ++page_iter) {
...
void testBufMgr() {
  ...
  //Test buffer manager
  //Comment tests which you do not wish to run now. Tests are dependent on their preceding tests.
